...
package org.wso2.carbon.device.mgt.connectedcup.manager.service.impl;
...
public class ConnectedCupManagerService {
    ...
    public boolean register(@QueryParam("name") String name, @QueryParam("owner") String owner) {
        ...
        try {
            if (deviceManagement.getDeviceManagementService().isEnrolled(deviceIdentifier)) {
                createKeys(deviceId, name, owner);
            ...
            List<Device.Property> properties = new List<Device.Property>();
            ...
            properties.add(new Device.Property());
    ...
    public void createKeys(String deviceId, String name, String owner) throws AccessTokenException {
